...
const ScrollExpandMedia = ({
  ...
  const baseWidth = isMobileState ? 250 : 300;
  const mediaWidth = baseWidth + scrollProgress * (isMobileState ? 650 : 1250);
              ...
              >
                <motion.h1
                  ...
                  style={{
                    ...
                    textShadow: '0 2px 8px rgba(0, 0, 0, 0.4), 0 4px 20px rgba(0, 0, 0, 0.2)'
                  }}
                >
                  {firstWord}
                </motion.h1>
